...
public final class ClientFeedback {
    ...
    public static void register() {
        PlayerFeedback.registerJumpNotice(holder -> {
            ...
            client.gui.setOverlayMessage(Component.translatable("chat.heavyinventories.no_jump",
                    Component.translatable(holder.isOverEncumbered() ? "chat.heavyinventories.over_encumbered" : "chat.heavyinventories.encumbered")), false);
        });
    }
}
