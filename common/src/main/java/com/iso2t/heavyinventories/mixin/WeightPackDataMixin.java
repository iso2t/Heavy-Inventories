...
public abstract class WeightPackDataMixin implements WeightPackAccess {
    @Unique private volatile Optional<WeightPackData.Result> heavyinventories$weightPackData = Optional.empty();

    @Override public Optional<WeightPackData.Result> heavyinventories$getWeightPackData() {
        return heavyinventories$weightPackData;
    }

    @Override public void heavyinventories$setWeightPackData(WeightPackData.Result result) {
