...
import com.iso2t.heavyinventories.api.files.*;
...
class FileSafetyTest {
    ...
    @Test void weightEditPreservesOtherEntriesAndFields() throws Exception {
    ...
    @Test void malformedOrInvalidWeightFilesAreNeverReplaced() throws Exception {
        var file = directory.resolve("minecraft.json");
    ...
    @Test void invalidServerFileCannotBeOverwrittenByAnOperatorEdit() throws Exception {
    ...
    @Test void failedAtomicReplacementReportsFailureAndCleansTemporaryFiles() throws Exception {
    ...
    @Test void weightFileNamesCannotEscapeTheNamespaceDirectory() {
