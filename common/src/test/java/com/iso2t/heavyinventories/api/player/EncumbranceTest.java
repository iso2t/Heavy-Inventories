...
class EncumbranceTest {
	...
	@Test
	void thresholdsHaveNoGapsIncludingExtremeOverload () {
	...
	@Test
	void progressiveAndNinetyPercentModesHaveTheirOwnCurves () {
	...
	@Test
	void strengthAndArmorAreAdditiveAndCapacityChangesRebuildBonuses () {
	...
	@Test
	void strengthThresholdsStayContinuous () {
	...
	@Test
	void surefootedFloorsFollowLoadWithoutChangingEnchantmentLevel () {
		for (var mode : WalkingMode.values()) {
	...
	@Test
	void highLevelsAreCappedAndExemptPlayersKeepNormalMovement () {
