...
public final class DatapackReloadClient {
	...
	public static void tick (Minecraft client) {
		...
		if (checkpoint != null && checkpoint.id() > checked) {
			...
			if (!holder.hasServerState() || holder.serverRevision() != checkpoint.revision() || arrow == null || stone == null || arrow != checkpoint.arrow() || stone != checkpoint.stone() || Math.abs(holder.getWeight() - checkpoint.total()) > 0.0001f)
				return;
