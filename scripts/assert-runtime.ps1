...
$markers = switch ($Mode) {
    ...
    Client { @('RING HUD PASSED', 'RING COMPATIBILITY PASSED', 'CLIENT DATAPACK GAMEPLAY PASSED', 'CLIENT LIFECYCLE SMOKE PASSED', 'CLIENT WEIGHT CALCULATION PASSED', 'CLIENT MOVEMENT PASSED', 'ADMIN TOOLS PASSED', 'PLAYER FEEDBACK PASSED', 'GUI COMPATIBILITY PASSED', 'BASELINE COMPATIBILITY PASSED') }
    MultiplayerServer { @('MULTIPLAYER SERVER AUTHORITY PASSED', 'MULTIPLAYER RECONNECT SERVER PASSED', 'BASELINE COMPATIBILITY PASSED') }
    MultiplayerClient { @('MULTIPLAYER RING PASSED', 'MULTIPLAYER CLIENT AUTHORITY PASSED', 'MULTIPLAYER MOVEMENT PASSED', 'MULTIPLAYER RECONNECT CLIENT PASSED') }
}
